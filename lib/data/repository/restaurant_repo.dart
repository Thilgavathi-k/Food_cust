...
class RestaurantRepo {
  ...
  Future<Response> getRestaurantDetails(String restaurantID) async {
    ...
    return await apiClient.getData('${AppConstants.RESTAURANT_DETAILS_URI}1');
  }
  ...
  Future<Response> getRecentlyViewedRestaurantList(String type) async {
    return await apiClient.getData('${AppConstants.RECENTLY_VIEWED_RESTAURANT_URI}?type=$type');
  }
