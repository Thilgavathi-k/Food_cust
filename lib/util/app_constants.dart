...
class AppConstants {
  static const String APP_NAME = 'Foxpro';
  static const double APP_VERSION = 6.2;

  static const String BASE_URL = 'http://192.168.1.54/foodkart';
  // static const String BASE_URL = 'https://fox.vrikshatech.in';
  ...
  static const String RUNNING_SUBSCRIPTION_ORDER_LIST_URI =
  ...
  static const String PRODUCT_LIST_WITH_IDS_URI = '/api/v1/customer/food-list';
  static const String RECENTLY_VIEWED_RESTAURANT_URI =
      '/api/v1/restaurants/recently-viewed-restaurants';
  static const String SUBSCRIPTION_LIST_URL = '/api/v1/customer/subscription';
  static const String SEND_CHECKOUT_NOTIFICATION_URL =
  ...
  /// Deep Links
  static const String YOUR_SCHEME = 'Foxpro';
  static const String YOUR_HOST = 'fox.vrikshatech.in';
