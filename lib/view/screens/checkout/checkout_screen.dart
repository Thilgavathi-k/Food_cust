  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoggedIn ? GetBuilder<LocationController>(builder: (locationController) {
        ...
        //     if( orderController.distance != null && orderController.distance != -1 )
        //     {
        //       ZoneData _zoneData = null;
        //       double _perKmCharge =_zoneData.perKmShippingCharge ?? 0;
        //
        //       double _minimumCharge =  _zoneData.minimumShippingCharge ?? 0;
        //
        //       double _maximumCharge =  _zoneData.maximumShippingCharge;
        //
        ...
        //       _deliveryCharge = _deliveryCharge + orderController.extraCharge;
        //       _charge = _charge + orderController.extraCharge;
        //       if(_maximumCharge != null && _deliveryCharge > _maximumCharge){
        //         _deliveryCharge = _maximumCharge;
        //         _charge = _maximumCharge;
        //       }
        //       _deliveryCharge = _deliveryCharge + (_deliveryCharge * (_zoneData.increasedDeliveryFee/100));
        //       _charge = _charge + _charge * (_zoneData.increasedDeliveryFee/100);
        //
        //       // if(restController.restaurant.selfDeliverySystem == 0 && _zoneData.increasedDeliveryFeeStatus == 1){
        //       //   _deliveryCharge = _deliveryCharge + (_deliveryCharge * (_zoneData.increasedDeliveryFee/100));
        //       //   _charge = _charge + _charge * (_zoneData.increasedDeliveryFee/100);
        //       // }
        //
        ...
        //     bool _restaurantSubscriptionActive = false;
        //     int _subscriptionQty = orderController.subscriptionOrder ? 0 : 1;
        //     // if(restController.restaurant != null) {
        //     //
        //     //   _restaurantSubscriptionActive =  restController.restaurant.orderSubscriptionActive && widget.fromCart;
        //     //
        //     //   if(_restaurantSubscriptionActive){
        ...
        //     //           }
        //     //         }
        //     //         _subscriptionQty = DateConverter.getWeekDaysCount(orderController.subscriptionRange, _weekDays);
        ...
        //     //           }
        //     //         }
        //     //         _subscriptionQty = DateConverter.getMonthDaysCount(orderController.subscriptionRange, _days);
        //     //       }else {
        //     //         _subscriptionQty = orderController.subscriptionRange.duration.inDays;
        //     //       }
        //     //     }
        //     //   }
        //     //
        ...
        //     //     }
        //     //   }
        //     //   _price = PriceConverter.toFixed(_price);
        //     //   _addOns = PriceConverter.toFixed(_addOns);
        //     //   _discount = PriceConverter.toFixed(_discount);
        //     //   _couponDiscount = PriceConverter.toFixed(_couponDiscount);
        ...
        //     }
        //     _tax = PriceConverter.toFixed(_tax);
        //     _deliveryCharge = PriceConverter.toFixed(_deliveryCharge);
        //     double _total = _subTotal + _deliveryCharge - _discount - _couponDiscount + (_taxIncluded ? 0 : _tax) + orderController.tips;
        //     _total = PriceConverter.toFixed(_total);
        //
        ...
        //
        //               _isCashOnDeliveryActive && _restaurantSubscriptionActive ? Container(
        //                 width: context.width,
        ...
        //                   ) : SizedBox(),
        //                   SizedBox(height: orderController.subscriptionOrder ? Dimensions.PADDING_SIZE_LARGE : 0),
        //                 ]),
        //               ) : SizedBox(),
        //               SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
        //
        ...
        //                       value: 'delivery', title: 'home_delivery'.tr, charge: _charge,
        //                       isFree: yes,
        ...
        //                     ],
        //                   ) : SizedBox.shrink(),
        //                   SizedBox(height: orderController.orderType != 'take_away' && !orderController.subscriptionOrder ? Dimensions.PADDING_SIZE_SMALL : 0.0),
        //
        //                   Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        //                       Text(_subscriptionQty > 0 ? _subscriptionQty.toString() : 'calculating'.tr, style: robotoMedium),
        //                     ]),
        //                     Padding(
        //                       padding: EdgeInsets.symmetric(vertical: Dimensions.PADDING_SIZE_SMALL),
        //                       child: Divider(thickness: 1, color: Theme.of(context).hintColor.withOpacity(0.5)),
        ...
        //                       ),
        //                       Text(
        //                         _subscriptionQty > 0 ? PriceConverter.convertPrice(_total * _subscriptionQty) : 'calculating'.tr,
        //                         style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
        //                       ),
        //                     ]),
        //                   ]) : SizedBox(),
        ...
        //             }else if(orderController.subscriptionOrder && !_datePicked && orderController.subscriptionType == 'daily') {
        //               showCustomSnackBar('choose_time'.tr);
        //             }else if(orderController.subscriptionOrder && !_datePicked) {
        ...
        //                 showCustomSnackBar('restaurant_is_closed'.tr);
        //               }
        //             }else if (!_isAvailable && !orderController.subscriptionOrder) {
        ...
        //               }
        //
        //               List<SubscriptionDays> _days = [];
        //               for(int index=0; index<orderController.selectedDays.length; index++) {
        //                 if(orderController.selectedDays[index] != null) {
        //                   _days.add(SubscriptionDays(
        ...
        //                     scheduleAt: !restController.restaurant.scheduleOrder ? null : (orderController.selectedDateSlot == 0 && orderController.selectedTimeSlot == 0) ? null : DateConverter.dateToDateAndTime(_scheduleStartDate),
        //                     orderAmount: _total, orderNote: _noteController.text, orderType: orderController.orderType,
        //                     paymentMethod: orderController.paymentMethodIndex == 0 ? 'cash_on_delivery' : orderController.paymentMethodIndex == 1 ? 'digital_payment' : orderController.paymentMethodIndex == 2 ? 'wallet' : 'digital_payment',
        //                     couponCode: (Get.find<CouponController>().discount > 0 || (Get.find<CouponController>().coupon != null && Get.find<CouponController>().freeDelivery)) ? Get.find<CouponController>().coupon.code : null,
        ...
        //                     contactPersonName: _address.contactPersonName ?? '${Get.find<UserController>().userInfoModel.fName} ''${Get.find<UserController>().userInfoModel.lName}',
        ...
        //                     subscriptionType: orderController.subscriptionType, subscriptionQuantity: _subscriptionQty.toString(),
                ...
                children: [
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                            currentDate.weekday == 3 ?Text('Sunday order'.tr, style: robotoMedium):Container(),
                            currentDate.weekday == 3 ? SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL):Container(),
                            currentDate.weekday == 3 ?Row(
                              children: [
                                SizedBox(width: _isCashOnDeliveryActive ? Dimensions.PADDING_SIZE_SMALL : 0),
                                    ...
                                    child: Stack(children: [
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ListTile(
                                            leading: Image.asset(
                                              Images.regular_order, width: 30, height: 30,
                                ...
                                Expanded(
                                  child: InkWell(
                                    onTap: ()
                                    {
                                      setState(() {
                                        isSelected = true;
                                        startcurrentDate = DateTime.now().add(Duration(days: 2));
                                        print("DAYSUIOAUIT");
                                        print(startcurrentDate);
                                      });
                            ...
                            currentDate.weekday == 3 ?SizedBox(height: Dimensions.PADDING_SIZE_LARGE):Container(),
                            isSelected == true? Row(
                                  children: [
                                    Text('Sunday: ', style: TextStyle(color: Colors.orange, fontSize: 14),maxLines: 2,),
                                    SizedBox(width: 5,),
                                    Text(myFormat.format(startcurrentDate))
                            ...
                            //   orderController: orderController,
                            // ) : SizedBox(),
                           isSelected == false ? SubscriptionView(
                              orderController: orderController,
                            ) :Container()
                           //  Column(
                           //  crossAxisAlignment: CrossAxisAlignment.start,
                           //    children: [
                           //      Text('Select date for sunday order: ', style: TextStyle(color: Colors.orange, fontSize: 14),maxLines: 2,),
                           //      SizedBox(height: 10,),
                           //      InkWell(
                           //          onTap:() async {
                           ...
                           //            if (pickedDate != null && pickedDate.weekday ==7 )
                           //              {
                           //
                           //                setState(() {
                           //                  startcurrentDate = pickedDate;
                           //                });
                           //              }
                           //            else
                           //              {
                           //                Get.dialog(
                           //                    ConfirmationDialog(icon: Images.support,
                           //                      title: "Alert",
                           //                      description: 'Please select sunday'.tr, isLogOut: true,
                           ...
                           //                children: [
                           //                 startcurrentDate !=null ? Text('${(myFormat.format(startcurrentDate))}', style: TextStyle(color: Colors.black, fontSize: 14),maxLines: 2,):
                           //                  Text('select date', style: TextStyle(color: Colors.black.withOpacity(0.4), fontSize: 14),maxLines: 2,),
                           //
                           //                  //SizedBox(width: 30,),
                           //
                           ...
                           //        {
                           //          print("CURETDHGS");
                           //          print(myFormat.format(currentDate));
                           //          print(currentDate.weekday);
                           //          print(startcurrentDate.weekday);
                           //          if(currentDate.weekday == 2)
                           //          {
                           //            if(startcurrentDate != null)
                           //              {
                           //                setState(() {
                           //
                           //                });
                           //                if(startcurrentDate.weekday == 7)
                           //                {
                           //                  setState(() {
                           //                    sundayOrder = true;
                           //
                           ...
                           //                ConfirmationDialog(icon: Images.support,
                           //                  title: "Alert",
                           //                  description: 'You cant place this order now'.tr, isLogOut: true,
                           //                  onYesPressed: () => Get.offAllNamed(RouteHelper.getInitialRoute()),
                           //                ), useSafeArea: false);
                           //          }
                           //
                           ...
                           //
                           //
                           //            child: Center(child: Text('confirm'.tr, style: robotoMedium))),
                           //      ),
                           //      SizedBox(height: orderController.subscriptionOrder ? Dimensions.PADDING_SIZE_LARGE : 0),
                           //    ],
                           //  ),
                  ...
                  Container(
                    ...
                    child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: ()
                    {
                      ...
                      else if(orderController.subscriptionOrder && orderController.subscriptionRange == null&& isSelected == false) {
                        showCustomSnackBar('select_a_date_range_for_subscription'.tr);
                      }
                      // else if(isSelected == true && sundayOrder == false)
                      //   {
                      //     showCustomSnackBar('please confirm your sunday order'.tr);
                      //
                      //   }
                      // else if(orderController.subscriptionOrder && !_datePicked && orderController.subscriptionType == 'daily') {
                      //   showCustomSnackBar('choose_time'.tr);
                      ...
                      // }
                        ...
                        orderController.placeOrder(
                            ...
                            PlaceOrderBody(
                                ...
                                restaurantId: null,
                                distance: 1240.181,
                                scheduleAt: myFormat.format(startcurrentDate),
                                ...
                                addressType: "others",
                                subscriptionOrder: "1",
                                subscriptionType: "sunday",
                                subscriptionDays: [],
                                subscriptionQuantity: "1",
                                subscriptionStartAt: myFormat.format(startcurrentDate),
                                subscriptionEndAt:""
                            ):
                            PlaceOrderBody(
                              cart: carts, couponDiscountAmount: Get.find<CouponController>().discount, distance: orderController.distance,
