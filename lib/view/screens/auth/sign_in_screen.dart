                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    ...
                    return Column(
                      children: [
                        ...
                        Image.asset("assets/newimages/6.png",fit: BoxFit.fill, width:MediaQuery.of(context).size.width,height:300,),
                          ...
                          child: Column(children: [
                            ...
                            Row(children: [
                              ...
                              TextButton(
                                ...
                                child: Text('${'forgot_password'.tr}?',style: TextStyle(color:  Color(0xfffb8d07)),),
                              ),
                            ]
                            ),
                            ...
                            !authController.isLoading ? Column(children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  TextButton( onPressed: () => Get.toNamed(RouteHelper.getSignUpRoute()), child: Text('sign_up'.tr,style: TextStyle(color:  Color(0xfffb8d07)),))
                                ],
                              ),
                            ])
