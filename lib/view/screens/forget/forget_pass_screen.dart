        ...
        child: Center(child: Container(
          ...
          child: Column(
            children: [
              ...
              Image.asset(Images.forgot, height: 220,fit: BoxFit.fill,width: MediaQuery.of(context).size.width,),

              Text('Forgot Password?'.tr.toUpperCase(), style: robotoBlack.copyWith(fontSize: 25)),
