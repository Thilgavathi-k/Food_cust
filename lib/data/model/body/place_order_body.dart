...
class PlaceOrderBody {
  ...
  PlaceOrderBody(
    ...
    this._subscriptionDays = subscriptionDays;
    this._subscriptionQuantity = subscriptionQuantity;
    this._subscriptionStartAt = subscriptionStartAt;
    this._subscriptionEndAt = subscriptionEndAt;
  }
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    if (json[''] != null) {
      ...
      json['subscription_days'].forEach((v) {
        _subscriptionDays.add(new SubscriptionDays.fromJson(v));
      });
     }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['subscription_order'] = this._subscriptionOrder;
    data['subscription_type'] = this._subscriptionType;
    if (this._subscriptionDays != null) {
      data['subscription_days'] = jsonEncode(this._subscriptionDays.map((v) => v.toJson()).toList());
    }
    data['subscription_quantity'] = this._subscriptionQuantity;
    data['subscription_start_at'] = this._subscriptionStartAt;
    data['subscription_end_at'] = this._subscriptionEndAt;
    return data;
  }
}
