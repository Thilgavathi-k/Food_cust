...
class OrderView extends StatelessWidget {
  ...
  OrderView({@required this.isRunning, this.isSubscription = false});
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.end,
                                      children: [
                                        ...
                                        // Text("${orderList[index].orderAmount}"),
...
Divider(color: Theme.of(context).disabledColor, height: Dimensions.PADDING_SIZE_LARGE),
