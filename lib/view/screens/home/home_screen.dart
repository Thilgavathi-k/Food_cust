          ...
          child: ResponsiveHelper.isDesktop(context) ? WebHomeScreen(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                backgroundColor: ResponsiveHelper.isDesktop(context) ? Colors.transparent : Color(0xfffff5ee),
                title: Center(child: Container(
                  width: Dimensions.WEB_MAX_WIDTH, height: 50, color: Color(0xfffff5ee),
                  child: Row(children: [
                      ...
                      child: Padding(
                        ...
                        child: GetBuilder<LocationController>(builder: (locationController) {
                          return Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              InkWell(
                                child:  locationController.getUserAddress().addressType == 'home' ? Image.asset("assets/newimages/Artboard – 2.png",width: 30,height: 30,)
                                    : locationController.getUserAddress().addressType == 'office' ? Icons.work : Image.asset("assets/newimages/Artboard – 6.png",width: 30,height: 30,),
                    ...
                    InkWell(
                      child: GetBuilder<NotificationController>(builder: (notificationController) {
                        return Stack(children: [
                          Image.asset("assets/newimages/Artboard – 10.png",width: 30,height: 30,),
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(children: [
                        ...
                        Image.asset("assets/newimages/Artboard – 3.png",width: 30,height: 30,),
              ...
              SliverToBoxAdapter(
                child: Center(child: SizedBox(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Container(height: 10,width: MediaQuery.of(context).size.width,color: Color(0xfffff7f1),),
...
decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(30),topRight: Radius.circular(30)),color: Colors.white,),
                    ...
                    NearByButtonView(),
                    ItemCampaignView(),
                    _isLogin ? PopularRestaurantView(isPopular: false, isRecentlyViewed: true) : SizedBox(),
                    CuisinesView(),
