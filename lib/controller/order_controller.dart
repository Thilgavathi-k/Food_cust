...
import '../data/model/response/assigned_details_model.dart';
...
class OrderController extends GetxController implements GetxService {
  ...
  List<AssignedDetails> _assignOrders;
  ...
  List<AssignedDetails> get assignSchedule => _assignOrders;
  ...
  Future<List<OrderDetailsModel>> getOrderDetails(String orderID) async {
    ...
    if (response.statusCode == 200) {
      ...
      response.body['assigned_schedules'].forEach((assignedDetails) => _assignOrders.add(AssignedDetails.fromJson(assignedDetails)));
